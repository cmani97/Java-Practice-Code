    ...
    public static class MazePanel extends JPanel {
        ...
        private class AboutBox extends JDialog{
            ...
            public AboutBox(){
                ...
                JLabel version = new JLabel("Version: 7.0", JLabel.CENTER);
...
// 
        ...
        public MazePanel(int width, int height) {
            ...
            bfs.setBounds(600, 370, 70, 25);
            aStar.setBounds(530, 390, 70, 25);
            greedy.setBounds(600, 390, 85, 25);
